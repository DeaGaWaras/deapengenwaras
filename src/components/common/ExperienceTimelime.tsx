  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className={twMerge(
          'border-deep-sea flex w-full flex-col gap-3 rounded-xl border-4 bg-white p-4 text-black shadow-button-card md:w-5/6',
          position
  ...
  return (
    <div className="relative col-start-5 col-end-6 mr-6 md:mx-auto md:mr-10">
      <div className="flex h-full w-6 items-center justify-center">
        <div className="bg-deep-sea pointer-events-none h-full w-1"></div>
      </div>
      <LinkPreview url={url}>
        <motion.div
          whileInView={{ scale: 1 }}
          ...
          transition={{ duration: 0.3 }}
          viewport={{ once: true }}
          className="bg-midnight border-deep-sea absolute -left-4 top-1/2 -mt-10 flex h-14 w-14 rounded-full border-4 md:-left-7 md:h-20 md:w-20"
        >
          {type === 'Work' ? (
            <svg
