    ...
    >
      <ul
        className={twMerge(
          ...
          navBg &&
            'border-deep-sea text-deep-sea gap-4 rounded-xl border-2 bg-white p-4 shadow-nav-card',
        )}
      >
      ...
      {navBg && (
        <div
          ...
          className={twMerge(
            'bg-midnight border-deep-sea fixed top-0 my-4 hidden h-16 w-16 -rotate-120 cursor-pointer rounded-full border-4 duration-150 hover:-rotate-90 md:right-16 md:block',
            // !isProject
      ...
      <div className="flex md:hidden">
        ...
        >
          <IconContext.Provider
            value={{ className: 'text-4xl text-deep-sea p-2' }}
          >
      ...
      >
        <ul className="m-5 flex h-fit w-full flex-col items-center gap-8 rounded-xl bg-gray-100 px-3 py-6 text-lg font-light">
          {navLinks.map((link, index) => (
            ...
            >
              <span className="bg-deep-sea absolute bottom-0 h-1 w-0 rounded-md transition-all duration-300 ease-in-out group-hover:w-full"></span>
                ...
                return (
                  <li key={index}>
                    <a href={link.href} target="_blank" rel="noreferrer">
                      <IconContext.Provider
                        value={{ className: 'text-2xl text-deep-sea' }}
                      >
                        <Icon />
                      </IconContext.Provider>
                    </a>
